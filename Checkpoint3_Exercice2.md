...
![Capture d'écran 2025-01-21 174120](https://github.com/user-attachments/assets/51ae6427-b8ae-4fe4-bc9b-028c307555f4)

## Q.2.5.2 Quels types de communications sont autorisées ?

ct state established, related accept : les connexions déjà établies. iifname lo accept : trafic de bouclage. tcp dport ssh accept : ssh. ip protocol icmp accept : ping (icmp). ip6 nexthdr icmpv6 accept : ping6 (icmpv6).
...
![Capture d'écran 2025-01-21 174720](https://github.com/user-attachments/assets/c4b4cd7e-ff7a-4909-89fd-7ddd804041ea)
